            ...
            <div class="col-xl-3 col-lg-2 col-md-4 col-3 p-0">
                <div class="navbar-header">
                    <a class="navbar-brand page-scroll" href="index.html">
                        <img alt="pizzon" src="{{ asset('frontends/images/header-logo.png') }}">
                    </a>
                </div>
            </div>
                                    ...
                                    <ul class="sub-menu-level1">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="menu-grid">
                                                                <a href="shop-detail.html" class="menu-grid-center">
                                                                    <div class="pizza-menu">
                                                                        <img src="{{ asset('frontends/images/1.png') }}"
                                                                            alt="pizza">
                                                                    </div>
                                                                    <div class="pizza-det">
                                                        ...
                                                        <div class="col-xl-4 col-lg-4 col-md-4">
                                                            <div class="menu-grid">
                                                                <a href="shop-detail.html" class="menu-grid-center">
                                                                    <div class="pizza-menu">
                                                                        <img src="{{ asset('frontends/images/1-1.png') }}"
                                                                            alt="pizza">
                                                                    </div>
                                                                    <div class="pizza-det">
                                                        ...
                                                        <div class="col-xl-4 col-lg-4 col-md-4">
                                                            <div class="menu-grid">
                                                                <a href="shop-detail.html" class="menu-grid-center">
                                                                    <div class="pizza-menu">
                                                                        <img src="{{ asset('frontends/images/2.png') }}"
                                                                            alt="pizza">
                                                                    </div>
                                                                    <div class="pizza-det">
                                                        ...
                                                        <div class="col-xl-4 col-lg-4 col-md-4">
                                                            <div class="menu-grid">
                                                                <a href="shop-detail.html" class="menu-grid-center">
                                                                    <div class="pizza-menu">
                                                                        <img src="{{ asset('frontends/images/2-1.png') }}"
                                                                            alt="pizza">
                                                                    </div>
                                                                    <div class="pizza-det">
                                                        ...
                                                        <div class="col-xl-4 col-lg-4 col-md-4">
                                                            <div class="menu-grid">
                                                                <a href="shop-detail.html" class="menu-grid-center">
                                                                    <div class="pizza-menu">
                                                                        <img src="{{ asset('frontends/images/3.png') }}"
                                                                            alt="pizza">
                                                                    </div>
                                                                    <div class="pizza-det">
                                                        ...
                                                        <div class="col-xl-4 col-lg-4 col-md-4">
                                                            <div class="menu-grid">
                                                                <a href="shop-detail.html" class="menu-grid-center">
                                                                    <div class="pizza-menu">
                                                                        <img src="{{ asset('frontends/images/4.png') }}"
                                                                            alt="pizza">
                                                                    </div>
                                                                    <div class="pizza-det">
                                        ...
                                        <li class="level2 level2 menu-list-res">
                                            <ul class="sub-menu-level2 ">
                                                <li class="level3"><a href="menu-2.html"><span>■</span>Menu list</a>
                                                </li>
                                                <li class="level3"><a href="menu-1.html"><span>■</span>Menu grid</a>
                                                </li>
                            ...
                            <div class="megamenu mobile-sub-menu content">
                                <div class="megamenu-inner-top">
                                    <ul class="sub-menu-level1">
                                        <li class="level2">
                                            <ul class="sub-menu-level2 ">
                                                <li class="level3"><a href="blog-leftside.html"><span>■</span>Blog
                                                        Leftside</a></li>
                                                <li class="level3"><a href="blog-rightside.html"><span>■</span>Blog
                                                        rightside</a></li>
                                                <li class="level3"><a href="blog-detail.html"><span>■</span>Blog
                                                        detail</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="sub-menu-level1">
                                        <li class="level2">
                                            <ul class="sub-menu-level2 ">
                                                ...
                                                <li class="level3"><a href="shop-grid.html"><span>■</span>Shop
                                                        grid</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                            ...
                            <div class="cart-dropdown header-link-dropdown">
                                <ul class="cart-list link-dropdown-list">
                                    <li> <a class="close-cart"><i class="fa fa-times-circle"></i></a>
                                        <div class="media"> <a href="shop-detail.html" class="pull-left"> <img
                                                    alt="Pizzon" src="{{ asset('frontends/images/1.png') }}"></a>
                                            <div class="media-body"> <span><a href="shop-detail.html">margherita
                                                        pizza</a></span>
                                    ...
                                    <li> <a class="close-cart"><i class="fa fa-times-circle"></i></a>
                                        <div class="media"> <a class="pull-left"> <img alt="Pizzon"
                                                    src="{{ asset('frontends/images/2.png') }}"></a>
